...
class OrderStatus(db.Model):
    ...
    # Khóa ngoại phải trỏ chính xác vào order_id của bảng orders
    ...
    # 'order' giúp lấy thông tin Order từ một dòng OrderStatus
    # 'status_history' giúp lấy danh sách trạng thái từ một đối tượng Order
