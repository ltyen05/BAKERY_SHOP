...
export const branchApi = {
  getAllBranches: async () => {
    try {
      ...
      console.error('[branchApi] Error:', error.response?.data || error.message);
  ...
  getBranchDetail: async (branchId) => {
    try {
      ...
      console.error('[branchApi] getBranchDetail error:', error.response?.data || error.message);

      return {
        success: false,
        message: error.response?.data?.message || 'Không thể lấy thông tin chi nhánh',
        data: null
      };
    }
  },
  ...
  getBranchManager: async (branchId) => {
    try {
      ...
      console.error('[branchApi] getBranchManager error:', error.response?.data || error.message);

      return {
        success: false,
        message: error.response?.data?.message || 'Không thể lấy thông tin quản lý',
        data: null
      };
    }
  },
  ...
  addBranch: async (branchData) => {
    try {
      ...
      console.error('[branchApi] addBranch error:', error.response?.data || error.message);
  ...
  updateBranch: async (branchId, branchData) => {
    try {
      ...
      console.error('[branchApi] updateBranch error:', error.response?.data || error.message);

      return {
        success: false,
        message: error.response?.data?.message || 'Không thể cập nhật chi nhánh'
      };
    }
  },
  ...
  deleteBranch: async (branchId) => {
    try {
      ...
      console.error('[branchApi] deleteBranch error:', error.response?.data || error.message);
